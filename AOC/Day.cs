...
public abstract class Day<TIn1, TOut1, TIn2, TOut2> : IDay
{
    ...
    public TOut1 ParseAndSolveP1(StreamReader input) => SolvePart1(ParseInputPart1(input));

    public TOut2 ParseAndSolveP2(StreamReader input) => SolvePart2(ParseInputPart2(input));
